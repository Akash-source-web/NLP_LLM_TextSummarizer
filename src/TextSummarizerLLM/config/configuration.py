...
from TextSummarizerLLM.entity import (DataIngestionConfig, DataValidationConfig)

#Creating code for configration manager
class ConfigrationManager:
    ...
    #Creating Data manager for the data validation
